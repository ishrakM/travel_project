<?php
  ...
  if($_SERVER['REQUEST_METHOD']== "POST")
  {
    ...
    $usernameUpdated=$_POST['username'];
    $passwordUpdated=$_POST['password'];
    $nameUpdated=$_POST['name'];
    $emailUpdated=$_POST['email'];
    $phoneUpdated=$_POST['phone'];
    $roleUpdated=$_POST['user_role'];
    $user= $_SESSION['user'];
            ...
            <form role="form" name="profile-edit" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="username" placeholder="Username" name="username" value="<?php echo empty($usernameUpdated) ? $username : $usernameUpdated ?> ">
                </div>
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" class="form-control" id="name" placeholder="Your Full Name" name="name" value="<?php echo empty($nameUpdated) ? $name : $nameUpdated ?> ">
                </div>
                <div class="form-group">
                  <label for="email">Email address</label>
                  <input type="email" class="form-control" id="email" placeholder="Enter Email" name="email" value="<?php echo empty($emailUpdated) ? $email : $emailUpdated ?> ">
                </div>
                <div class="form-group">
