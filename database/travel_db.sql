...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2018 at 05:09 PM
...
INSERT INTO `hotels` (`hotel_id`, `title`, `addedBy`, `location`, `image`, `hotel_desc`, `deletedAt`) VALUES
(2, 'Hotel Edison', NULL, 'New York, USA', 'dist/img/hotel-1-1.jpg', 'A small river named Duden flows by their place and supplies it with the necessary regelialia.', NULL),
(3, 'Hotel Raddison', NULL, 'Dhaka, Bangladesh', 'dist/img/hotel-2-1.jpg', 'A small river named Duden flows by their place and supplies it with the necessary regelialia.', NULL),
(5, 'Hotel Agrabad', 'khalid', 'New Delhi, India', 'dist/imghotel-4.jpg', 'A small river named Duden flows by their place and supplies it with the necessary regelialia.', NULL);
